(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu") && document.querySelector(".close-menu")) {
    ...
    function initSliders() {
        if (document.querySelector(".cards-section__slider")) new core(".cards-section__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            speed: 800,
            navigation: {
                prevEl: ".cards-section__arr_prev",
                nextEl: ".cards-section__arr_next"
            },
            breakpoints: {
                0: {
                    slidesPerView: 1
    ...
    window.addEventListener("load", (function(e) {
        ...
        const cardsCntFront = document.querySelectorAll(".front-card__content");
        const cardsCntBack = document.querySelectorAll(".back-card__content");
        if (cardsCntFront.length > 0 && cardsCntBack.length > 0 && cards.length > 0) {
            let height = [];
            cardsCntFront.forEach((el => {
                height.push(el.clientHeight);
            }));
            cardsCntBack.forEach((el => {
                height.push(el.clientHeight);
            }));
